...
function GLBoiler() {
    ...
    this.gl.clearColor(0.5, 0.2, 0.1, 1.0);
...
GLBoiler.prototype.update = function(dt) {
};

GLBoiler.prototype.draw = function() {
...
GLBoiler.prototype.spawnBrick = function(x, y) {
    var brick = new Brick(x, y, 10, 10);

    this.bricks.push(brick);
};

GLBoiler.prototype.getGL = function() {
    var gl,
        canvas = $('canvas').get(0);
...
GLBoiler.prototype.getShaderProgram = function(vert, frag) {
...
GLBoiler.prototype.setUniforms = function() {
...
GLBoiler.prototype.loadIdentity = function() {
    this.modelViewMatrix = [
        1, 0, 0,
        0, 1, 0,
        0, 0, 1
...
GLBoiler.prototype.matrixMultiply = function(a, b) {
  var a00 = a[0*3+0];
  var a01 = a[0*3+1];
  var a02 = a[0*3+2];
  var a10 = a[1*3+0];
...
GLBoiler.prototype.makeProjectionMatrix = function(width, height) {
    return [
        2 / width, 0,          0,
        0,        -2 / height, 0,
       -1,         1,          1
